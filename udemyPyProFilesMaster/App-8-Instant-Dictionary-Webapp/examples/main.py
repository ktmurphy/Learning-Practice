...
def home():
    ...
    in1 = jp.Input(a=div1, placeholder="Enter first value", classes="form-input")
    in2 = jp.Input(a=div1, placeholder="Enter second value", classes="form-input")
    ...
    jp.Button(a=div2, text="Calculate", click=sum_up, in1=in1, in2=in2, d=d_output,
              classes="border boarder-blue-500 m-2 py-1 px-4 rounded "
              "text-blue-600 hover:bg-red-500 hover:text-white")
    jp.Div(a=div2, text="I am a cool interactive div!", mouseenter=mouse_enter, mouseleave = mouse_leave, classes= "hover:bg-red-500")
    return wp
